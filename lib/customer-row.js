...
/** UPSERT 用 args: property_id, customer_id, 17 denorm..., payload, remote_payload, local_overrides */
function rowArgsForUpsert(propertyId, remoteRow, mergedRow, localOverridesJson) {
